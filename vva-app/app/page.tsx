...
export default function Home() {
    ...
    <div className='flex flex-col justify-center items-center mb-72'>
        ...
        <div className='flex '>
                ...
                <Select onValueChange={setDate}>
                    ...
                    <Select onValueChange={setGrandPrix}>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="Singapore">United States</SelectItem>
                            <SelectItem value="Singapore">Mexico</SelectItem>
                            <SelectItem value="Singapore">Brazil</SelectItem>
                            <SelectItem value="Singapore">Las Vegas</SelectItem>
                            <SelectItem value="Singapore">Qatar</SelectItem>
                            <SelectItem value="Singapore">Abu Dhabi</SelectItem>
                        </SelectContent>
                    </Select>
                </div>
            ...
            <Button className='mt-10 w-[200px] text-xl' variant="destructive" onClick={handleSubmit}>Predict</Button>
        {response && (
